...
AppPublisher=AlphaCode Team
AppPublisherURL=https://github.com/jessy2027/AlphaCodeIDE
AppSupportURL=https://github.com/jessy2027/AlphaCodeIDE/issues
AppUpdatesURL=https://github.com/jessy2027/AlphaCodeIDE/releases
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=AlphaCodeIDESetup
Compression=lzma
...
SetupIconFile={#RepoDir}\resources\win32\alphacode.ico
...
#if "user" == InstallTarget
Source: "appx\{#AppxPackage}"; DestDir: "{app}\appx"; BeforeInstall: RemoveAppxPackage; Flags: ignoreversion external skipifsourcedoesntexist; Check: IsWindows11OrLater
Source: "appx\{#AppxPackageDll}"; DestDir: "{app}\appx"; AfterInstall: AddAppxPackage; Flags: ignoreversion external skipifsourcedoesntexist; Check: IsWindows11OrLater
#endif
#endif
