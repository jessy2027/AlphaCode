...
import { IViewContainersRegistry, ViewContainerLocation, Extensions as ViewContainerExtensions, IViewsRegistry, Extensions as ViewExtensions, IViewDescriptor } from '../../../common/views.js';
import { SyncDescriptor } from '../../../../platform/instantiation/common/descriptors.js';
import { VIEWLET_ID, VIEW_CONTAINER_TITLE_VALUE, VIBE_CODING_VIEW_ID, VIBE_CODING_VIEW_TITLE } from '../common/alphacode.js';
...
// Register Services
registerSingleton(IAlphaCodeAIService, AlphaCodeAIService, InstantiationType.Delayed);
registerSingleton(IAlphaCodeChatService, AlphaCodeChatService, InstantiationType.Delayed);
registerSingleton(IAlphaCodeContextService, AlphaCodeContextService, InstantiationType.Delayed);
registerSingleton(IAlphaCodeAgentService, AlphaCodeAgentService, InstantiationType.Delayed);
registerSingleton(IAlphaCodePairProgrammingService, AlphaCodePairProgrammingService, InstantiationType.Delayed);
registerSingleton(IAlphaCodeSecurityService, AlphaCodeSecurityService, InstantiationType.Delayed);
